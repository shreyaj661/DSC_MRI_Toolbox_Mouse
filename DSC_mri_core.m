...
% %----- ENTRY OF VECTOR DIMENSIONS OPTIONS ------------------------------
...
%----- ENTERING TIMES IN THE VECTOR OPTIONS -------------------------------
options.te=te;
options.tr=tr;
...
%----- CALCULATION OF CONCENTRATIONS AND S0 ------------------------------
if options.conc
    conc=volumes;
    options.aif.nSlice=aif.sliceAIF;
%----- CALCULATION SI s0 - OPTIONAL -----------------------------------------
elseif nargout > 7
